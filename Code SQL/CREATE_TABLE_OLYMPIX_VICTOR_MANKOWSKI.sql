...
CREATE TABLE IF NOT EXISTS `e22007619_db2`.`t_candidature_cdt` (
  ...
  `cnc_id` INT NOT NULL,
  `cdt_date_inscription` INT NOT NULL,
  INDEX `fk_t_candidature_cdt_t_categorie_cat1_idx` (`cdt_date_inscription` ASC) VISIBLE,
  INDEX `fk_t_candidature_cdt_t_concours_cnc1_idx` (`cnc_id` ASC) VISIBLE,
  PRIMARY KEY (`cdt_id`),
  CONSTRAINT `fk_t_candidature_cdt_t_categorie_cat1`
    FOREIGN KEY (`cdt_date_inscription`)
